---
title: "Documentation"
source: "https://albumentations.ai/docs/3-basic-usage/performance-tuning/"
author:
published:
created: 2025-11-13
...
*(For advice on selecting augmentations that improve model generalization, see the [Choosing Augmentations](https://albumentations.ai/docs/3-basic-usage/choosing-augmentations/) guide.)*
...
![Image Loading Performance Comparison](https://albumentations.ai/_next/image/?url=https%3A%2F%2Fgithub.com%2Fternaus%2Fimread_benchmark%2Fblob%2Fmain%2Fimages%2Fperformance_darwin.png%3Fraw%3Dtrue&w=3840&q=85)

*Source: [imread\_benchmark repository](https://github.com/ternaus/imread_benchmark) - "Need for Speed: A Comprehensive Benchmark of JPEG Decoders in Python" by Vladimir Iglovikov*
...
**Recommendation:** Use OpenCV (`cv2.imread`) or torchvision (`torchvision.io.decode_image`) for optimal performance. The [imread\_benchmark repository](https://github.com/ternaus/imread_benchmark) provides detailed benchmarks across different platforms and libraries.
...
- **[Apply to Your Task](https://albumentations.ai/docs/3-basic-usage/):** Return to the specific basic usage guides (e.g., Classification, Segmentation) and integrate these performance tips.
- **[Revisit Choosing Augmentations](https://albumentations.ai/docs/3-basic-usage/choosing-augmentations/):** Evaluate the performance impact of the transforms you selected for generalization.
...
- **[Dive into Advanced Guides](https://albumentations.ai/docs/4-advanced-guides/):** Explore further customization and optimization options.